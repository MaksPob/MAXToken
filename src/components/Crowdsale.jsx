        ...
        <Col>
          ...
          <Row>
            <Col md={{ size: 6 }}>
              ...
              <Row>Tokens sold: {(crowdsale.salesTokens / crowdsale.decimals).toLocaleString()} MAX</Row>
              <Row>Token cost: {(crowdsale.rate / crowdsale.decimals).toFixed(7).toLocaleString()} ETH</Row>
              <Row>Softcap: {(crowdsale.softcap / crowdsale.decimals).toLocaleString()} MAX</Row>
            </Col>
          </Row>
          <hr className="my-2" />
          ...
          <Row>
            <Col>
              ...
              <Row>Tokens amount: {(preICO.totalSupply / crowdsale.decimals).toLocaleString()} MAX</Row>
              <Row>Tokens left: {(preICO.remainderTokens / crowdsale.decimals).toLocaleString()} MAX</Row>
          ...
          <Row>
            <Col>
              <Row><h5>ICO</h5></Row>
              <Row>Tokens amount: {(ICO.totalSupply / crowdsale.decimals).toLocaleString()} MAX</Row>
              <Row>Tokens left: {(ICO.remainderTokens / crowdsale.decimals).toLocaleString()} MAX</Row>
          ...
          <Row>
            <Col>
              ...
              <Row>Tokens sold: {(postICO.totalSupply / crowdsale.decimals).toLocaleString()} MAX</Row>
              <Row>Tokens left: {(postICO.remainderTokens / crowdsale.decimals).toLocaleString()} MAX</Row>
